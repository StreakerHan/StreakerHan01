...
import com.hyp.utils.IPKit;
import com.hyp.utils.PatternKit;
...
public class HomeController extends BaseController{
	...
	public String getAbout(HttpServletRequest request) {
		this.blogBaseData(request, null); //获取友情链接
		request.setAttribute("active", "about");
		return "site/about";
	}
	
	@ApiOperation("blog首页") //表示一个http请求的操作
	@GetMapping(value = {"/bolg/", "/blog/index"})
